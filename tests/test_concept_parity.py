...
# Paths
ROOT_DIR = "/home/apps/workspace/agent-packages/agents/stirlingpdf-agent"
...
def test_concept_parity():
    """
    Enforces that all concepts documented or used in stirlingpdf-agent
    ...
    assert not unregistered_concepts, (
        f"The following concepts are used in stirlingpdf-agent but are NOT registered "
