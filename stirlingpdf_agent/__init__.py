...
OPTIONAL_MODULES = {
    "stirlingpdf_agent.agent_server": "agent",
    "stirlingpdf_agent.mcp_server": "mcp",
}
...
_MCP_AVAILABLE = OPTIONAL_MODULES.get("stirlingpdf_agent.mcp_server") in [
    m.__name__ for m in globals().values() if hasattr(m, "__name__")
]
_AGENT_AVAILABLE = "stirlingpdf_agent.agent_server" in globals()
